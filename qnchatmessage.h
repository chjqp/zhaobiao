...
//     QRect m_nameLeftRect;    // 左侧名字矩形
//     QRect m_titleLeftRect;   // 左侧职称矩形
//     QRect m_nameRightRect;   // 右侧名字矩形
//     QRect m_titleRightRect;  // 右侧职称矩形
...
private:
    ...
    QRect m_nameRightRect;   // 右侧名字矩形
    QRect m_titleRightRect;  // 右侧职称矩形
    QLabel* m_nameLabel;     // 显示用户昵称的 QLabel
    QLabel* m_titleLabel;    // 显示用户职称的 QLabel
