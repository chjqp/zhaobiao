...
//     }
// }
// filepath: /path/to/QNChatMessage.cpp

// QSize QNChatMessage::fontRect(QString str)
// {
//     m_msg = str;
//     int minHei = 40; // 增加最小高度
//     int iconWH = 50; // 增加头像宽高
//     int iconSpaceW = 25; // 增加头像间距
//     int iconRectW = 10; // 增加头像矩形宽度
//     int iconTMPH = 15; // 增加头像顶部间距
//     int sanJiaoW = 8; // 增加三角宽度
//     int kuangTMP = 30; // 增加框体间距
//     int textSpaceRect = 15; // 增加文本间距
//     int nameTitleHeight = 60; // 增加名字和职称的高度
...
//     hei += nameTitleHeight; // 增加名字和职称的高度
...
//     m_textLeftRect.setRect(m_kuangLeftRect.x() + textSpaceRect, m_kuangLeftRect.y() + iconTMPH + nameTitleHeight,
//                            m_kuangLeftRect.width() - 2 * textSpaceRect, m_kuangLeftRect.height() - 2 * iconTMPH - nameTitleHeight);
//     m_textRightRect.setRect(m_kuangRightRect.x() + textSpaceRect, m_kuangRightRect.y() + iconTMPH + nameTitleHeight,
//                             m_kuangRightRect.width() - 2 * textSpaceRect, m_kuangRightRect.height() - 2 * iconTMPH - nameTitleHeight);
...
//         // 昵称和职称
//         QFont font = this->font();
//         font.setPointSize(6); // 设置职称和名字的字体大小为6
//         font.setWeight(QFont::Bold); // 设置字体粗体
//         painter.setFont(font);
//         painter.setPen(QColor(105, 105, 105)); // 使用深灰色字体

//         // 设置矩形区域来绘制昵称和职称，调整了它们之间的间距
//         QRect nameRect(m_iconLeftRect.x(), m_iconLeftRect.bottom() + 5, m_iconLeftRect.width(), 12);
//         QRect titleRect(m_iconLeftRect.x(), m_iconLeftRect.bottom() + 17, m_iconLeftRect.width(), 12);
...
//         font.setWeight(QFont::Bold); // 设置字体粗体
//         painter.setFont(font);
//         painter.setPen(QColor(0, 0, 0)); // 使用黑色字体

//         // 设置矩形区域来绘制昵称和职称，调整了它们之间的间距
//         QRect nameRect(m_iconRightRect.x(), m_iconRightRect.bottom() + 5, m_iconRightRect.width(), 12);
//         QRect titleRect(m_iconRightRect.x(), m_iconRightRect.bottom() + 17, m_iconRightRect.width(), 12);
...
//         font.setPointSize(12); // 恢复气泡里的文字字体大小为12
//         painter.setFont(font);
//         painter.drawText(m_textLeftRect.adjusted(0, 0, 0, 0), m_msg, option); // 调整文本框大小
//     } else if (m_userType == User_Type::User_Me) {  // 自己消息
//         // 头像
//         painter.drawPixmap(m_iconRightRect, m_rightPixmap);
...
//         font.setPointSize(12); // 恢复气泡里的文字字体大小为12
//         painter.setFont(font);
//         painter.drawText(m_textRightRect.adjusted(0, 0, 0, 0), m_msg, option); // 调整文本框大小
//     } else if (m_userType == User_Type::User_Time) {  // 时间消息
//         QPen penText;
//         penText.setColor(QColor(153, 153, 153)); // 使用浅灰色字体
//         painter.setPen(penText);
...
QSize QNChatMessage::fontRect(QString str)
{
    ...
    int nameTitleHeight = 60; // 名字和职称的高度
    ...
    int hei = size.height() < minHei ? minHei : size.height();
    hei += nameTitleHeight; // 加上名字和职称的高度
